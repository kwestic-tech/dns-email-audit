...
export function createDnsEngine({ publicSuffixRules, dkimSelectorCatalog, platform }) {
  ...
  // TRANSITIONAL collaborator: it stays here beside `parseSpfTerms()` because
  // §12 gives DKIM no edge to core/spf/, and Task 4.0's ruling forbids both
  // importing it and copying the grammar. Task 4.8 creates the SPF owner and
  // Phase 5 moves the derivation to the audit layer, which is where
  // cross-protocol composition belongs.
  const {
