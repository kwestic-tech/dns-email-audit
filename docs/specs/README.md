...
| --- | --- | --- | --- |
| [mx-host-validity](mx-host-validity.md) | 0.9.1 released, then 0.9.2 | 1.7 (Final, amended) | **0.9.1 released as `v0.9.1`**; **0.9.2 implemented and in code review**, privacy review accepted 2026-09-05 |
