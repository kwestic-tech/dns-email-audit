...
eq('the reviewed vocabulary is 112 tokens', issueAlgebra.length, 112);
...
eq('and it is the 112 migrated keys plus the ten cross-protocol ones',
  algebra('audit.finding.key').members.length, 122);
