...
over from the review's spike — 8 additional queries across 80 background
domains, and 4 for the dedicated vanity case.
...
| 0.9.2 | [mx-host-validity](docs/specs/mx-host-validity.md) | 0.9.1 released; privacy review **accepted 2026-09-05**; spec `1.6 (Final, amended)`; implemented, in code review | Forward-confirmed reverse DNS and provider address-set divergence | Forward-confirmed reverse DNS and provider address-set divergence |
...
- A spec is Final before implementation starts. For a multi-release spec, that
  is per release: `mx-host-validity` `1.6` covers 0.9.1, which shipped, and
