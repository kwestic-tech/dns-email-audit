...
[`docs/specs/mx-host-validity.md`](docs/specs/mx-host-validity.md) (`0.7`). **0.9.1 is
...
Spec: [`docs/specs/mx-host-validity.md`](docs/specs/mx-host-validity.md), **`0.7`
...
| 0.9.1 | [mx-host-validity](docs/specs/mx-host-validity.md) | `v0.9.0` released; spec `0.7`, **0.9.1 implemented** | MX address-scope classification; address-literal and null-MX-conflict diagnosis |
...
- A spec is Final before implementation starts. For a multi-release spec, that
  is per release: `mx-host-validity` `0.7` approves 0.9.1 only.
